...
export function NavbarDefault() {
  ...
  const navList = (
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      >
        ...
        <Link to="/dashboadtakecareguardians" className="flex items-center">
  ...
  return (
    <Navbar className="block sm:hidden md:hidden xl:hidden mx-auto rounded-none max-w-screen-xl px-4 py-2 lg:px-8 lg:py-4 bg-caqui-900">
      <div className="container mx-auto flex items-center justify-between text-white">
        <img src={logo} height={30} width={30} className="mr-4" />
        <Typography
          as="a"
          href="#"
